...
io.savemat('positions.mat',{'matrix':Ppt})
...
print('Hollow sites:',Hollowsites)

io.savemat('adspositions.mat',{'matrix':Hollowsites})

p=read('pt.xyz')
for i in range(len(Hollowsites)):
    p.append(Atom('H',position=Hollowsites[i]))

write('Pt_H_ads.xyz',p)
